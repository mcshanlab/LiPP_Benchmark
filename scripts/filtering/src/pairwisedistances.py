...
"""
Pairwise Distance Calculator for PyMOL

Original script source: PyMOL Wiki
https://wiki.pymol.org/index.php/Pairwise_distances

This module calculates pairwise distances between atoms in two selections
within a specified maximum distance cutoff.

Usage:
    pairwise_dist(sel1, sel2, max_dist, output="N", sidechain="N", show="N")
"""
...
def pairwise_dist(sel1, sel2, max_dist, output="N", sidechain="N", show="N"):
	...
	"""
	print('using local pairwisedistances script')
	print("")
	cmd.delete("dist*")
	extra=""
	if sidechain=="Y":
